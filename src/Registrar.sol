...
contract BaseRegistrarImplementation is ERC721, Ownable {
    ...
    bytes4 private constant ERC721_ID = bytes4(
        keccak256("balanceOf(address)") ^ keccak256("ownerOf(uint256)")
            ^ keccak256("approve(address,uint256)") ^ keccak256("getApproved(uint256)")
    ...
    function supportsInterface(bytes4 interfaceID)
        ...
        returns (bool)
    {
        return interfaceID == INTERFACE_META_ID || interfaceID == ERC721_ID
